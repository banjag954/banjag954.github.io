...
>_현재의 IT 생태계는 당연하게도 과거부터 현재까지의 수많은 개발자들의 희생으로 만들어졌다.<br /> __IA, Wireframe 같은 문서 작성 규칙 및 방법__ 이나 __디자인 가이드에 대한 방법론__ 역시 초기에는 개발자들의 손안에서 탄생했을 것이라는 이야기이다._
...
![dev_image]({{ site.url }}/assets/images/typography-poster-posters-quote.jpg)
...
이렇게 대화가 끝난 후, 제품이 출시됬다.

만약 제품이 나온 후, 소비자가 사용성에 대해 불편함을 느낀다면 당연히 해당 영역에 대한 책임은 __설계자__ 가 지는 것이 당연할 것이다.
하지만 __개발자__ 에게 이것에 대한 책임을 묻는 경우가 많다.

___이 문제에 대한 영역을 보통 에러로 사람들이 인지하기 때문이다.___

욕을 먹은 __개발자__ 는 __설계자__ 에게 찾아가 이야기한다. 하지만 __설계자__ 는 자신의 일이 늘어난다며 실증을 낸다.
